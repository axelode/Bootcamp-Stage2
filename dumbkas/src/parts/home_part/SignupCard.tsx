    ...
    return (
        <div className="w-full h-screen fixed flex justify-center items-center backdrop-blur-sm z-50">
            <div className="flex flex-col p-5 bg-white rounded-lg border-[1px] border-black shadow-xl">
                <h1 className="text-4xl font-bold text-[#22577A]">Register</h1>
                ...
                <p className="mt-5 text-center text-[#22577A]">Already have an account ? Klik <span className="font-bold"><a href="">Here</a></span></p>
            </div>
        </div>
    )
}